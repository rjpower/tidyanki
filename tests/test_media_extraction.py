...
def test_image_detection():
    ...
    fields = ["English text", '<img src="image123.jpg">', "More text", "Other field"]
...
def test_mixed_media():
    ...
    fields = ['Text with <img src="photo.png">', "[sound:audio.mp3]", "Plain text"]
...
def test_no_media():
    ...
    fields = ["Plain text", "No media here", "Just words"]
...
def test_multiple_media_in_single_field():
    ...
    fields = ['Text <img src="pic1.jpg"> more text [sound:file.mp3] end']
